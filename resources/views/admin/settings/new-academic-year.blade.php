...
>
    ...
    <section class="space-y-5">
        ...
        <div class="rounded-lg border border-emerald-200 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.07)]" style="background-color: #ecfdf5;">
            <div class="flex items-start gap-4">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-2 text-sm leading-6 text-emerald-800">
                        ...
                        After saving, scholar users will be imported automatically from the
                        <span class="font-semibold">OMM ACE List</span> for graduating year
                        <span class="font-mono font-semibold">{{ $nextGraduationYear }}</span>.
                    </p>
                </div>
            </div>

            <form method="POST" action="{{ route('admin.settings.project-mappings.store') }}" class="mt-6 grid gap-4 sm:grid-cols-2">
                @csrf
                ...
                <div>
                    ...
                    <input
                        ...
                        id="graduation_year"
                        value="{{ old('graduation_year', $nextGraduationYear) }}"
                ...
                <div class="sm:col-span-2 sm:flex sm:justify-end">
                    <flux:button type="submit" variant="primary" icon="check">Save and import scholars</flux:button>
                </div>
            </form>
        </div>
    </section>
